  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
          ...
          <div className="container relative py-16 md:py-24 lg:py-32">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
                className="mt-8 flex flex-wrap items-center justify-center gap-6 text-sm text-accent">
                <div className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5" /><span className="font-medium">No insurance</span></div>
                <div className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5" /><span className="font-medium">No membership fee</span></div>
                <div className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5" /><span className="font-medium">Pay only when you need us</span></div>
              </motion.div>
            </div>
          </div>
        </motion.div>
      ...
      <section className="bg-secondary py-16 md:py-24">
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-foreground md:text-4xl">Why 50,000+ drivers trust us</h2>
            <p className="mx-auto max-w-2xl text-muted-foreground md:text-lg">We've reimagined roadside assistance for the modern world. Fast, transparent, and always reliable.</p>
          </motion.div>
          ...
          <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            {services.map((service) => (
              <motion.div key={service.name} variants={item}>
                <div 
                  className={`h-full relative cursor-pointer rounded-2xl border transition-all hover:scale-105 ${service.popular ? 'border-primary ring-2 ring-primary bg-primary/5' : 'border-border bg-card hover:shadow-md'}`}
