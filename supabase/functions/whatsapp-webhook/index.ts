...
async function buildPayfastLink(args: {
  ...
  const data: Record<string, string> = {
    ...
    return_url: `https://nownowassist.co.za/payment-result?status=success&job=${args.jobId}`,
    cancel_url: `https://nownowassist.co.za/payment-result?status=cancelled&job=${args.jobId}`,
