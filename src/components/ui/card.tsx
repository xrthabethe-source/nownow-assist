  ...
  "rounded-2xl border text-card-foreground transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        dark: "bg-brand-dark text-brand-white border-transparent",
        interactive: "bg-card border-border shadow-sm hover:shadow-md hover:border-primary/50 cursor-pointer",
