      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-border">
        <div className="container flex items-center justify-between py-3 md:py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button size="sm" className="hidden sm:flex font-medium" onClick={() => navigate("/auth")}>Drive with us</Button>
          </div>
        </div>
      </header>
        ...
        <div className="container">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="mt-12 text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-success/10 px-6 py-3">
              <Heart className="h-5 w-5 text-success" /><span className="text-lg font-semibold text-success">Now-Now Assist has your back.</span>
            </div>
          </motion.div>
        </div>
      </section>
